      ...
      <div class="row">
        ...
        <p class="login_para_title">ADMIN PANEL</p>
          <div class="list-group" align="center" style="width: 50%; border: 1px solid #053a5a; border-radius: 5px;">
            ...
            <a href="job-posts.php" class="list-group-item active" style="font-size: 20px; color:black; background-color:lightblue;">Job Posts</a>
          </div>
        </div>
        <br>
        ...
        <br>
          ...
          <br><br>
          <div align="center"margin-top: 10px; height: 55px;">
